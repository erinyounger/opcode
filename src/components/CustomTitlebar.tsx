...
export const CustomTitlebar: React.FC<CustomTitlebarProps> = ({
  ...
  return (
    ...
    >
      {/* Left side - Window Controls (macOS style only) */}
      ...
      {/* Right side - Navigation icons + Window Controls (Windows/Linux style) */}
      <div className="flex items-center gap-3 tauri-no-drag">
        ...
        {/* Window controls for Windows/Linux style - placed at the end (rightmost) */}
